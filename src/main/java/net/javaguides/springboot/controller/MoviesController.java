...
public class MoviesController {
	...
	@GetMapping("movies")
	public ResponseEntity<?> getAllMoviesInfos(@RequestParam(value="search", required=false , defaultValue="")String search){
		List<Movies> save=moviesServices.getAllMoviesInfos(search);
		return new ResponseEntity<>(save,HttpStatus.OK);
	}
